...
| ksocBootstrapper.image.semver | string | `""` | If set will allow flux to promote images. (i.e 1.0.x) |
| ksocBootstrapper.image.tag | string | `"v0.0.0"` |  |
...
| ksocGuard.image.semver | string | `""` | If set will allow flux to promote images. (i.e 1.0.x) |
| ksocGuard.image.tag | string | `"v0.0.0"` |  |
...
| ksocSbom.image.semver | string | `""` | If set will allow flux to promote images. (i.e 1.0.x) |
| ksocSbom.image.tag | string | `"v0.0.0"` |  |
...
| ksocSync.image.semver | string | `""` | If set will allow flux to promote images. (i.e 1.0.x) |
| ksocSync.image.tag | string | `"v0.0.0"` |  |
...
| ksocWatch.image.semver | string | `""` | If set will allow flux to promote images. (i.e 1.0.x) |
| ksocWatch.image.tag | string | `"v0.0.0"` |  |
